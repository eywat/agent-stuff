...
### Convert + summarize with Gemini 3 Flash (pass context!)
...
3) run `pi --provider ollama --model google/gemini-3-flash-preview` (no-tools, no-session) to summarize using your extra prompt
